...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        "cn-font-heading text-base font-medium text-content-default-primary",
        className,
      )}
      {...props}
    />
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("text-sm text-content-default-tertiary", className)}
      {...props}
    />
  );
}
